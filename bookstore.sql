...
INSERT INTO `user`(`name`,`email`) VALUES ('Tommy Huang','xtommy@sjtu.edu.cn');
INSERT INTO `user`(`name`,`email`) VALUES ('Admin','admin@sjtu.edu.cn');
INSERT INTO `user`(`name`,`email`) VALUES ('Admin2','admin2@sjtu.edu.cn');
INSERT INTO `user`(`name`,`email`) VALUES ('demo user','demo@sjtu.edu.cn');
...
INSERT INTO `user_auth` VALUES ('1','xtommy','123','0');
...
100
人文类
《巴黎圣母院》艺术地再现了四百多年前法王路易十一统治时期的历史真实，宫廷与教会如何狼狈为奸压迫人民群众，人民群众怎样同两股势力英勇斗争。本书以1482年的法国为背景，以吉普赛姑娘爱丝美拉达与年轻英俊的卫队长，道貌岸然的副主教以及畸形、丑陋的敲钟人之间的关系为主线，热情呕歌了吉普赛姑娘与敲钟人高尚的品格，深刻鞭挞了卫队长与副主教的虚伪与卑下。
https://cdn.jsdelivr.net/gh/xtommy-1/Images@master/2daeea1d202dfd335f7e50c4956c11a9.3xrsrqiqkm4g.jpeg
名著名译丛书
